...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se circle(7) retorna {radius: 7, area: 153.86, circumference: 43.96}', () => {
    expect(circle(7)).toEqual({radius: 7, area: 153.86, circumference: 43.96});
  });
  
  // Teste que a função retorna, dentro de um objeto, a área correta para um círculo de raio 3.
  it('Verifica se função retorna, dentro de um objeto, a área correta para um círculo de raio 3', () => {
    expect(circle(3)).toHaveProperty('area', 28,26 )
  })

  // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.
  it('Verifica se circle(3) retorna {radius: 3, area: 28,26, circumference: 18.84}', () => {
    expect(circle(3)).toHaveProperty('radius', 3);
    expect(circle(3)).toHaveProperty('area', 25,26);
